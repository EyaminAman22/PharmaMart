    ...
    <div class="w-4/5">
        ...
        <div class=" mt-5 text text-center"> 
            ...
            <div class="mt-12 text-center">
                <a class="inline-block rounded-lg py-1 px-2 font-semibold hover:text-white   hover:bg-navy text-white bg-indigo duration-700 ease-in-out show-pickup" href="#">Proceed</a>

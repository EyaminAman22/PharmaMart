...
<body class="m-0 p-0 font-pop">  
  <div class="flex">
    ...
    <h1 class="inline-block rounded-xl font-semibold text-20 text-white p-4 bg-navy">Expiry Details</h1>
    <table class=" mt-4 table-auto text-center mx-auto bg-navy text-white border  border-white border-collapse">
        <thead>
            <tr class="">
                ...
                <th class="p-2 border  border-white text-red-500">Expire Date</th>
            </tr>
        </thead>
        <tbody class="">
            <tr class="">

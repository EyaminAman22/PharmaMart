            ...
            <div class="flex mt-2 ml-16 justify-start flex-wrap gap-8">
                <div class="w-1/6 border duration-700 ease-in-out rounded-lg shadow bg-navy hover:bg-li-navy">
                    <div class="flex flex-col items-center py-5">
                        <img class="block w-1/4 mb-3 shadow-lg" src="./images/nivialotion.png"
                            alt="Bonnie image" />
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Nivia Lotion</h5>
                        <span class="text-sm text-gray-500 dark:text-gray-400">1000ml</span>
